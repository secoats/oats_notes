...
* **SeBackupPrivilege** - READ access to ALL files, ignoring ACL (access control list) restrictions (ignore file ownership). Use this to copy SAM, SYSTEM and SECURITY, from which you can extract Admin hashes.
...
* **SeLoadDriverPrivilege** - Load a kernel driver. Allows privesc to SYSTEM using a variety of exploits involving the loading of exploitable drivers.
